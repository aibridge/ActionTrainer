...
parser.add_argument('--inp_dim', dest='inp_dim', type=str, default='320',
                    help='inpdim')
...
parser.add_argument('--theta',
                    help='theta threshold for comparison', default=30)
parser.add_argument('--T_path', help='path of trainer video',  default='/home/AI-Bridge_User/Downloads/AlphaPose_p/2.mp4')
